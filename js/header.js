...
$('.menu_1').mouseover(function() {
	$(".drop1").fadeIn("slow");
	$(".drop2, .drop3, .drop4, .drop5, .drop6, .drop7, .drop8").css("display", "none");		
 });	
...
$('.menu_2').mouseover(function() {
	$(".drop2").fadeIn("slow");	
	$(".drop1, .drop3, .drop4, .drop5, .drop6, .drop7, .drop8").css("display", "none");
});	
...
$('.menu_3').mouseover(function() {
	$(".drop3").fadeIn("slow");
	$(".drop1, .drop2, .drop4, .drop5, .drop6, .drop7, .drop8").css("display", "none");	
});
...
$('.menu_4').mouseover(function() {
	$(".drop4").fadeIn("slow");
	$(".drop1, .drop2, .drop3, .drop5, .drop6, .drop7, .drop8").css("display", "none");	
});
...
$('.menu_5').mouseover(function() {
	$(".drop5").fadeIn("slow");
	$(".drop1, .drop2, .drop3, .drop4, .drop6, .drop7, .drop8").css("display", "none");	
});	
...
$('.menu_6').mouseover(function() {
	$(".drop6").fadeIn("slow");
	$(".drop1, .drop2, .drop3, .drop5, .drop4, .drop7, .drop8").css("display", "none");	
});	
...
$('.menu_7').mouseover(function() {
	$(".drop7").fadeIn("slow");
	$(".drop1, .drop2, .drop3, .drop5, .drop6, .drop4, .drop8").css("display", "none");	
});
...
$('.menu_8').mouseover(function() {
	$(".drop8").fadeIn("slow");
	$(".drop1, .drop2, .drop3, .drop5, .drop6, .drop4, .drop7").css("display", "none");	
});
$('.drop8').mouseover(function() {
	$(".drop8").css('display','block');
});				 		
    $('.menuDrop, .item').mouseout(function() {
		$(".menuDrop").css("display", "none");
		$(".drop1, .drop2, .drop3, .drop4, .drop5, .drop6, .drop7, .drop8").css("display", "none");			
		 }	
	);		 
